...
class Connect extends Diviner{
    constructor(argObj){
        ...
        Object.defineProperties(this, {
            _readyToExecuteCount: { value: 0, writable: true }
        })
    }

    async readyToExecute(){ 
        // first time always return false to ensure prompts are raised when interactive
        if(this._readyToExecuteCount === 0){
            this._readyToExecuteCount += 1;
