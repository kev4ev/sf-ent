...
class Diviner extends EventEmitter{
    ...
    async #dispatchLifecycleEvent(evt, payload){
        ...
        if(this.parent){
                ...
                case 'done':
                    ...
                    for(const key in this.parent.#doneQueue){
                        ...
                        if(!queueItem.filled){
                            ...
                            // also fire payload to all non-parent handlers here so they do not 
                            // receive it out-of-order as compared with parent 
                            emitEvt();
                        }
                    }
                    break;
            ...
            // no parent, just emit the evt and payload
            emitEvt();
        }
    }
