 ...
 * @property {function({ name: string, value: any, prompt: Enquirer.Prompt }): boolean | Promise<boolean>} [onCancel]
 * @property {function({ name: string, value: any, prompt: Enquirer.Prompt }): boolean | Promise<boolean>} [onSubmit] this will always be set to instances answerHandler() method
 */
