...
const relay = require('../types/DivinerPromise');
...
class Diviner {
    ...
    async run(){
        ...
        // prerun lifecycle
        await this.preRun();
        // check ready status and conditionally raise prompts
        ...
        // check again and conditionally exit
    ...
    relayInteractive(divinerInit){
        return relay(divinerInit(this.args), this);
    }
