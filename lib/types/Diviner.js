...
/**
 * @typedef {object} DivinerArgs args object that may be expanded by extending classes; generally, all 
 * instance config properties should be passed as arg properties
...
class Diviner /** extends EventEmitter */{
    ...
    /**
     * Execute logic after all data is ready. Must return either the result execution, or
     * the Promise resulting from initiating the run of another Diviner to which control has been relayed.
     * @returns {Promise<any|Promise<any>>}
     * ```
     * // example of returning the pending Promise of a Diviner run (do not preface with `await`)
     * return eagerDiviner(DivinerProto, this.args);
     * ```
     */
